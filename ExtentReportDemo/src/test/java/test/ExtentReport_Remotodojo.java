...
public class ExtentReport_Remotodojo {
	private static WebDriver driver = null;

	public static void main(String[] args) throws InterruptedException, IOException {

		ExtentReports extent = new ExtentReports();
		ExtentSparkReporter spark = new ExtentSparkReporter("target/Remotodojo_Report.html"); /* Test Report is saved in Target folder */
		extent.attachReporter(spark);

		// Test 1 RESTRATION FORM
		ExtentTest test1 = extent.createTest("Remotodojo Registration Test", "this is a test to validate Registration Form functionality");
		...
		if (driver.getTitle().equals("RemotoDojo | Accounts - Get-access")) {
		...
		// TEST 2 LOGIN FORM
		ExtentTest test2 = extent.createTest("RemotoDojo Login Test","this is a test to validate Login Form Functionality");
		System.setProperty("webdriver.chrome.driver",projectPath + "/drivers/chromedriver/chromedriver_win32/chromedriver.exe");
		driver = new ChromeDriver();
		...
		Thread.sleep(1000);
		if (driver.getTitle().equals("RemotoDojo | Accounts - Get-access")) {
			test2.log(Status.PASS, "Navigated to the RemotoDojo Login Page");
		} else {
...
//		driver.findElement(By.xpath("//*[@id=\"mat-input-5\"]")).sendKeys("kristel.juen");
		...
		ExtentTest test3 = extent.createTest("RemotoDojo Business Angels Test", "this is a test Get in Touch Form Functionality");
		System.setProperty("webdriver.chrome.driver",projectPath + "/drivers/chromedriver/chromedriver_win32/chromedriver.exe");
		driver = new ChromeDriver();
		...
		Thread.sleep(1000);
		if (driver.getTitle().equals("RemotoDojo | Business")) {
		...
		ExtentTest test4 = extent.createTest("RemotoDojo Articles Page", "this is a test Form Functionality");
		System.setProperty("webdriver.chrome.driver", projectPath + "/drivers/chromedriver/chromedriver_win32/chromedriver.exe");
		driver = new ChromeDriver();
		...
		ExtentTest test5 = extent.createTest("RemotoDojo Contact Page", "this is a test to Validate actual text");
		...
		ExtentTest test6 = extent.createTest("RemotoDojo Application Page", "this is a Form Functionality Test");
