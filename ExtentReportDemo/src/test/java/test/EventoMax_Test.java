...
public class EventoMax_Test {
	...
	public static void main(String[] args) throws Exception {
		...
		ExtentSparkReporter spark = new ExtentSparkReporter(
				"target/EventoMax_ExtentReport.html"); /* Test Report is saved in Target folder */
...
//		Thread.sleep(1000);
		...
		/* TEST 2 */
		ExtentTest test2 = extent.createTest("EventoMax About Page",
		...
		// Test 3
		ExtentTest test3 = extent.createTest("EventoMax Careers Page",
		...
		// Test 4 ARTICLES
		ExtentTest test4 = extent.createTest("EventoMax Articles Page",
		...
		ExtentTest test5 = extent.createTest("EventoMax Business Angels Page",
		...
		// Test 6 CONTACT FORM
		ExtentTest test6 = extent.createTest("EventoMax Contact Page",
		...
		ExtentTest test7 = extent.createTest("EventoMax Registration and Log-in Page",
